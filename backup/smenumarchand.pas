...
implementation
  const
    ...
    txtPayWoodX           =50; //abcisse de txtSuivant
    txtPayFishX           =50; //abcisse de txtGestionbatiment
    txtPayLaineX          =50; //abcisse de txtGestionbatiment
    txtPayTissuX          =50;  //abcisse de txtGestionbatiment
    txtPayToolX           =50; //abcisse de txtTest2
